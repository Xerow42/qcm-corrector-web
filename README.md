...
|-|-|-|
|`NEXT\_PUBLIC\_API\_URL`|`http://127.0.0.1:8000`|Base URL of the backend API|
|`NEXT\_PUBLIC\_DEMO\_TEACHER\_EMAIL`|`teacher@example.com`|Teacher e-mail pre-filled in the "New MCQ" form (must exist in your backend)|
|`NEXT\_PUBLIC\_DEMO\_TEACHER\_ID`|`1`|Teacher id pre-filled in the "New MCQ" form|
...
* **`NEXT\_PUBLIC\_\*` variables are public.** They are embedded in the browser bundle. Never store a secret in them.
